...
- **MIT OR Apache-2.0 OR Zlib** (3 crates)
...
- **MIT OR Apache-2.0 OR BSD-1-Clause** (1 crates)
- **MIT OR Zlib OR Apache-2.0** (1 crates)
- **Zlib** (1 crates)
...
- `hf-hub` 0.3.2 — https://github.com/huggingface/hf-hub
...
- `sync_wrapper` 0.1.2 — https://github.com/Actyx/sync_wrapper
- `sync_wrapper` 1.0.2 — https://github.com/Actyx/sync_wrapper
- `tao` 0.35.3 — https://github.com/tauri-apps/tao
- `tokenizers` 0.20.4 — https://github.com/huggingface/tokenizers
...
- `rustls-pemfile` 1.0.4 — https://github.com/rustls/pemfile
...
- `rayon-cond` 0.3.0 — https://github.com/cuviper/rayon-cond
...
- `bip39` 2.2.2 — https://github.com/rust-bitcoin/rust-bip39/
- `bitcoin_hashes` 0.14.101 — https://github.com/rust-bitcoin/rust-bitcoin
- `hex-conservative` 0.2.2 — https://github.com/rust-bitcoin/hex-conservative
...
- `h2` 0.3.27 — https://github.com/hyperium/h2
...
- `ulid` 1.2.1 — https://github.com/dylanhart/ulid-rs
...
- `winreg` 0.50.0 — https://github.com/gentoo90/winreg-rs
...
- `diffy` 0.5.1 — https://github.com/bmwill/diffy
...
- `ndarray` 0.15.6 — https://github.com/rust-ndarray/ndarray
...
- `reqwest` 0.11.27 — https://github.com/seanmonstar/reqwest
